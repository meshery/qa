...
- Name: events.spec.ts >> events route >> shows audit card with non-zero count
- Location: e2e/events.spec.ts:58:7
...
Call log:
  ...
  - waiting for getByText('42').first()
