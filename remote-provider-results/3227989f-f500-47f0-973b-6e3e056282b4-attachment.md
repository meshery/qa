...
- Name: nav-permission-shield.spec.ts >> the Organizations nav item >> stays visible for an org member holding ONLY View Org
- Location: e2e/nav-permission-shield.spec.ts:440:7
