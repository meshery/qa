...
- Name: design-crud.spec.ts >> design CRUD flows >> renders a user design from the mocked designs list
- Location: e2e/design-crud.spec.ts:52:7
...
- textbox "I’m having an issue with...": "An error occurred on the page at http://localhost:3000/catalog on 8/6/2026, 12:49:59 AM. Error Details: Cannot read properties of undefined (reading 'toString'). System Version: Not Available"
- checkbox [checked]
- img
