...
- Name: auth/email-signup.spec.ts >> email signup — main domain >> captcha required: submit gated until token solved
...
- generic [active] [ref=e1]:
  - main [ref=e3]:
    ...
    - generic [ref=e44]:
      - generic [ref=e45]:
        - generic [ref=e46]:
          - img "Composable Infrastructure" [ref=e47]
          - img "Composable Infrastructure" [ref=e48]
        - heading "Composable Infrastructure" [level=3] [ref=e49]
        - paragraph [ref=e50]: Choose from thousands of versioned cloud native components.
      - list [ref=e51]:
        - listitem [ref=e52]:
