...
- Name: design-import.spec.ts >> import design — canonical form contract at the product surface >> URL Import branch posts { save, url, patternData.name }
- Location: e2e/design-import.spec.ts:108:7
