...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e151]:
              ...
              - generic:
                ...
                - generic [ref=e228]:
                  ...
                  - generic [ref=e246]:
                    ...
                    - textbox "I’m having an issue with..." [ref=e271]: "An error occurred on the page at http://localhost:9081/settings on 1/16/2026, 8:24:11 PM. Error Details: n is not a function."
                  - generic [ref=e273]:
                    - generic [ref=e274]:
      ...
      - generic [ref=e290]:
        - img [ref=e291]
        - paragraph [ref=e293]: MeshSync connected in embedded mode
        - group [ref=e295]:
          - button "Open" [ref=e296] [cursor=pointer]:
            - img [ref=e297]
          - button "Close" [ref=e301] [cursor=pointer]:
            - img [ref=e302]
  - alert [ref=e304]: Meshery
```